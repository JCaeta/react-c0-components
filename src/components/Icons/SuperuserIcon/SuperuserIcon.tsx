...
import "./SuperuserIcon.css";

export const SuperuserIcon = (props: any) => 
{
    document.documentElement.style.setProperty('--color_superuser-icon_rctc0comps', props.color);
    document.documentElement.style.setProperty('--color-hover_superuser-icon_rctc0comps', props.colorHover);
    document.documentElement.style.setProperty('--color-click_superuser-icon_rctc0comps', props.colorClick);

    return (<>
        <svg version="1.1" id="superuser-icon_rctc0comps" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 1000 1000" width="100%" height="100%" enableBackground="new 0 0 1000 1000">
