export const customViewports = {
    ...
    mobileView2: {name: "Mobile view 2 ", styles: { width: "412px", height: "846px"}},
    mobileView3: {name: "Mobile view 3 ", styles: { width: "414px", height: "736px"}},
    mobileView4: {name: "Mobile view 4 ", styles: { width: "412px", height: "869px"}},
    mobileView5: {name: "Mobile view 5 ", styles: { width: "385px", height: "854px"}},
    mobileView6: {name: "Mobile view 6 ", styles: { width: "360px", height: "720px"}},
    mobileView7: {name: "Mobile view 7 ", styles: { width: "428px", height: "926px"}},
